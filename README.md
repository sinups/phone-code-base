...
### Парсер номеров с сайта [sanstv](https://sanstv.ru/)
 
#### Загрузить все страницы (Автокликером)
...
#### Если достаточно информации останавливаем
```js
...
<th>Добавлено</th></tr>
```
##### На ето. Делается для того чтобы в json попал правильный ключ .
```html
<th>&nbsp;</th>
<th>code</th>
<th>country</th>
